...
try:
    while not rospy.is_shutdown():
        ...
        if center[0] == 0 and center[1] == 0:
            ...
            if x_center_image < -180 and x_center_image > 180 and radius<90:
                twist.angular.z = -(0.001*x_center_image)
                twist.linear.x = 0
            elif x_center_image < -50 or x_center_image > 50:  # This means ball is to the left of the bot
                if radius > 100:
                    ...
                    print("Aligning with the distant ball")
                    twist.angular.z = -(0.001*x_center_image)
                    twist.linear.x = (100-radius)*0.005
                    prev_x = x_center_image
            else:
                if radius < 100:
                    print("moving forward in a straight line")
                    twist.linear.x = (100-radius)*0.01
                    twist.angular.z = 0
                    prev_x = x_center_image
                else:
                    print("stopping")
